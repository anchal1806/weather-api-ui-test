...
let getWeatherForCity = new getWeatherForCity();
...
I.say('Jammu temperature from Accuweather UI is : '+jammuTempFromUI);
 ...
 let jammuTempFromAPI = await getWeatherForCity.weatherMapAPI(apiHelperPage.apiURL,constantsPage.jammuCity,apiHelperPage.unitMetric,apiHelperPage.apiKey);
...
I.say('Bengaluru temperature from Accuweather UI is : '+bengaluruTempFromUI );
 ...
 let bengaluruTempFromAPI = await getWeatherForCity.weatherMapAPI(apiHelperPage.apiURL,constantsPage.bengaluruCity,apiHelperPage.unitMetric,apiHelperPage.apiKey);
